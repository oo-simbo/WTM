        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if (list[i] && list[i].url) {
                    ...
                    img.width = 113;
                    img.setAttribute('src', urlPrefix + list[i].src + (list[i].src.indexOf('?') == -1 ? '?noCache=' : '&noCache=') + (+new Date()).toString(36));
                    img.setAttribute('_src', urlPrefix + list[i].src);
    ...
    SearchImage.prototype = {
        ...
        getImageData: function () {
            var _this = this,
                ...
                url = "http://image.baidu.com/search/index?tn=baiduimage&ipn=r&ct=201326592&cl=2&lm=-1&st=-1&fm=result&fr=&sf=1&fmq=1569221553883_R&pv=&ic=0&nc=1&z=0&hd=0&latest=0&copyright=0&se=1&showtab=0&fb=0&width=&height=&face=0&istype=2&ie=utf-8&sid=&word=" + _this.encodeToGb2312(key); //+ type + "&keeporiginname=" + keepOriginName + "&" + +new Date;
